...
#SBATCH -o .onager/logs/slurm/%x_%A.o
#SBATCH -e .onager/logs/slurm/%x_%A.e

eval "$(/data/home/pteterwak/miniconda3/bin/conda shell.bash hook)"
conda activate llava_retrieve_v3
