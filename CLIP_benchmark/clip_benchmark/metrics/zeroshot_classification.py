    ...
    with torch.no_grad(), autocast():
        ...
        for classname in tqdm(classnames):
            if type(templates) == dict:
                ...
                #texts = ["USER: What are useful features for distinguishing a {} style of {} in a photo? \n ASSISTANT: There are several useful features to tell there is a {} in a photo".format(rnd, classname,classname) for rnd in {'sdfsdf','tyhthy','iojioj','dfjnijkmnwer','sdfdfsfdsdfopijojnbtfqwe','apkoew'}]
                #texts = ["USER: What are useful features for distinguishing a {} from a list of {} possible classes in a photo? \n ASSISTANT: There are several useful features to tell there is a {} in a photo".format(classname,classnames,classname)]
                #texts = ["USER: A photo of a CIFAR-100 class, a {}, which has several visual attributes: \n ASSISTANT: There are several useful features to tell there is a {} in a photo".format(classname,classname)]
                #texts = ["USER: A photo of a {}\n ASSISTANT:".format(classname,classname)]
                #texts = ["USER: A photo of a {}.A {} has the following visual attributes ASSISTANT: 1. ".format(classname,classname)]
                ...
                #texts = ["A photo of a {}.".format(classname,classname)]
            else:
                raise ValueError("templates must be a list or a dict")
            #texts = ["USER: {}\n ASSISTANT: One can recognize a photo of this class with the following visual features".format(t) for t in texts]
            #texts = ["USER: What are useful features for distinguishing a {} in a photo? \n ASSISTANT: There are several useful features to tell there is a {} in a photo".format(t,t) for t in texts]
